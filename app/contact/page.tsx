      ...
      <section className="max-w-[1200px] mx-auto px-6 py-14 grid md:grid-cols-2 gap-8 items-center">
        <div>
          ...
          <div className="mt-6 flex gap-3">
            <Link href="#" className="rounded-full btn-primary px-6 py-3 text-sm font-semibold">Schedule</Link>
            <Link href="#" className="rounded-full border border-white/20 hover:border-white/40 px-6 py-3 text-sm font-semibold">Contact Us</Link>
          </div>
        </div>
