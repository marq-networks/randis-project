        ...
        <div className="relative bg-gradient-to-br from-slate-800 via-slate-900 to-blue-900 rounded-2xl border border-blue-500/30 p-8 lg:p-12 overflow-hidden">
          ...
          <div className="relative grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-2">
                <button className="inline-flex items-center px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors duration-200 group text-sm">
            ...
            <div className="space-y-4">
              {features.map((feature, index) => (
                <div key={index} className="bg-slate-800/50 border border-slate-700/50 rounded-lg p-4 backdrop-blur-sm">
