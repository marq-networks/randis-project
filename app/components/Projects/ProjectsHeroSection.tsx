  ...
  return (
    <section className="relative overflow-hidden h-[70vh] mx-auto">
      ...
      <div className="absolute inset-0 -z-10">
        <Image
          src="/ourProjects/Rectangle 34625406.png"
      ...
      <div className="max-w-[1200px] min-h-[72vh] md:min-h-[80vh] mx-auto px-6 flex items-center justify-center">
        ...
        >
          ...
          >
            Explore our portfolio of successful enterprise transformations and discover how we have helped organizations achieve breakthrough results.
          </p>
